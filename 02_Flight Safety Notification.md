...
[Github Edit](https://github.com/dji-sdk/Cloud-API-Doc/blob/master/docs/en/02.flight-safety-notification.md) 

### [#](https://developer.dji.com/doc/cloud-api-tutorial/en/flight-safety-notification.html#key-functions-development)Key Functions Development
...
- [Locate Last Known Position](https://developer.dji.com/doc/cloud-api-tutorial/en/api-reference/dock-to-cloud/mqtt/dock/dock1/device.html): Issue a task to request the device to report the aircraft's latitude and longitude parameter in osd properties, and upload it to could servers using the Dock or the remote controller.
...
### [#](https://developer.dji.com/doc/cloud-api-tutorial/en/flight-safety-notification.html#firmware-upgrade)Firmware Upgrade
